package com.anson.smbms.servlet.bill;

import com.anson.smbms.pojo.Bill;
import com.anson.smbms.pojo.Provider;
import com.anson.smbms.pojo.User;
import com.anson.smbms.service.bill.BillService;
import com.anson.smbms.service.bill.BillServiceImpl;
import com.anson.smbms.service.provider.ProviderService;
import com.anson.smbms.service.provider.ProviderServiceImpl;
...
public class BillServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		BigDecimal totalPriceBigDecimal = 
				//設置規則，小數點保留兩位，多出部分，ROUND_DOWN 捨棄
				//ROUND_HALF_UP 四捨五入(5入) ROUND_UP 進位
				//ROUND_HALF_DOWN 四捨五入（5不入）
